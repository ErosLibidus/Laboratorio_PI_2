...
def dataFrame():
    df = pd.read_csv("/home/dio-pc/Descargas/COVID-19_Reported_Patient_Impact_and_Hospital_Capacity_by_State_Timeseries.csv")
...
imagen = Image.open("/home/dio-pc/Descargas/imagen.jpg")
